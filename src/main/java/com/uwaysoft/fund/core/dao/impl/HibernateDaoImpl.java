package com.uwaysoft.fund.core.dao.impl;
...
import com.uwaysoft.fund.core.dao.HibernateDao;
...
public class HibernateDaoImpl implements HibernateDao {
     ...
     * @param values
     */
     @Override public int bulkUpdate(String queryString, Object[] values){
      ...
      * @param entities
      */
     @Override public <T> void deleteAll(Collection<T> entities){
    	 for (T obj : entities){
